...
object ApplicationPreferences {
    ...
    private const val SHOW_RESOURCE_COLLECTIONS_IN_SIDEBAR_KEY = "ui.show_resource_collections_in_sidebar"
    ...
    fun getShowResourceCollectionsInSidebar(): Boolean = safeGetBoolean(SHOW_RESOURCE_COLLECTIONS_IN_SIDEBAR_KEY, true)
    fun setShowResourceCollectionsInSidebar(show: Boolean) = safePutBoolean(SHOW_RESOURCE_COLLECTIONS_IN_SIDEBAR_KEY, show)
